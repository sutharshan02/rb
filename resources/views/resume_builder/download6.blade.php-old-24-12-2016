...
.education td.description p.bold {
  font-weight: bold;
}
    ...
    <tr>
      <th  colspan="2" st>
        <p>
          ...
          <span class=""> {{$data['personal']['address']}} - {{$data['personal']['city']}} - {{$data['personal']['state']}} {{$data['personal']['zip_code']}} </span>
...
<!--         <p>
 ...
 -->
        <p>
          <span class="">Phone: {{$data['personal']['phone_no']}}  </span>
       <span style="padding: 2px;">&#9899;</span>
          <span class="">Email  {{$data['personal']['email_address']}}</span>
        </p>
      </th>
  ...
  <table cellspacing="0" class="main">
    <tr class="hr">
      ...
      <td colspan="2" class="description">
        ...
        <p style="text-align: left; padding-bottom:30px;">{{$data['personal']['profile_description']}} </p>
    ...
    <tr class="education">
      ...
      <td colspan="2" class="description job">
        ...
        <p <?php echo ($i == 0) ? "class='title' style='font-weight: bold;'>Education" : ">";  ?></p>

        <p class="company bold">{{$education['school_name']}}, {{$education['location']}}</p>
  ...
  <tr class=''>
    ...
    <td class="description job">
       ...
       <p <?php echo ($i == 0) ? "class='title' style='font-weight: bold;'>Experience" : ">";  ?></p>
      <table>
        <tr class="work-title">
          <td colspan='2'>
...
@if($data['skills']['skills'])
  ...
  @endif
<tr style="padding-top: 10px;" class="hr">
