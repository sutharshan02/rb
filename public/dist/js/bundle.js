...
app.config(function($sceProvider, $routeProvider, config, $locationProvider){
  ...
  {
    templateUrl: config._views_url + "selectTemplate.html",
...
app.controller('ResumeController', 
  function($scope, $localStorage, $sessionStorage, $http, config, $location, cvData , lang) {
...
app.controller('WorkController', function($scope, $localStorage, $sessionStorage, $http, config, $location, cvData){
  $scope.loadingError = false;
  $scope.showLoader = function() {
    $scope.loading = 'true';
  }
...
$scope.updateJob = function(job) {
    ...
    if(job.end_year != null && job.end_month != null) {
...
app.controller('skillController', function($scope, $localStorage, $sessionStorage, $http, config, $location, cvData){
  ...
  loadDefinedSkills();
     ...
     $scope.autoInput = function() {
      ...
      $scope.addItem = function() {
        ...
        console.log($scope);
        console.log(typeof $scope.skills == "undefined");
...
app.controller('EducationController', function($scope, $localStorage, $sessionStorage, $http, config, $location, cvData){
$scope.template_id = $sessionStorage.template_id;
...
$scope.updateSchool = function(school, index) {
    ...
    if(school.graduation_year != null && school.graduation_month != null) {
  ...
  $scope.new = {
    ...
    'description' : '',
      ...
      $scope.addEducation = function(){
        ...
        if(graduation_year && graduation_month){
...
app.controller('templateController', function($scope, $localStorage, $sessionStorage, $http, config, $location,cvData) {
